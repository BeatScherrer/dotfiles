...
class BazelWorkspaceFolderTreeItem {
    ...
    getDirectoryItems() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const packagePaths = yield new bazel_1.BazelQuery(configuration_1.getDefaultBazelExecutablePath(), workspacePath, "...:*", []).queryPackages();
            const topLevelItems = [];
            ...
            const queryResult = yield new bazel_1.BazelQuery(configuration_1.getDefaultBazelExecutablePath(), workspacePath, `:all`, [], true).queryTargets([], /* sortByRuleName: */ true);
