...
class BazelWorkspaceInfo {
    ...
    static fromDocument(document) {
        ...
        const bazelWorkspace = bazel_utils_1.getBazelWorkspaceFolder(uri.fsPath);
        if (bazelWorkspace) {
    ...
    static fromWorkspaceFolder(workspaceFolder) {
        const bazelWorkspace = bazel_utils_1.getBazelWorkspaceFolder(workspaceFolder.uri.fsPath);
        if (bazelWorkspace) {
